...
public class ExcelWriteAddExecutor extends AbstractExcelWriteExecutor {
    ...
    private void addOneRowOfDataToExcel(Object oneRowData, int n, int relativeRowIndex,
        ...
        if (oneRowData instanceof List) {
            addBasicTypeToExcel((List) oneRowData, row, relativeRowIndex, class_);
        } else {
    ...
    private void addBasicTypeToExcel(List<Object> oneRowData, Row row, int relativeRowIndex, Class class_) {
