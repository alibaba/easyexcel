...
import com.github.byteautumn.excel.analysis.v07.XlsxSaxAnalyser2;

/**
 * @author jipengfei
 */
public class ExcelAnalyserImpl3 implements ExcelAnalyser {
    private static final Logger LOGGER = LoggerFactory.getLogger(ExcelAnalyserImpl3.class);
    ...
    public ExcelAnalyserImpl3(ReadWorkbook readWorkbook) {
        try {
    ...
    private void choiceExcelExecutor(ReadWorkbook readWorkbook) throws Exception {
        ...
        switch (excelType) {
            ...
            case XLSX:
                XlsxReadContext xlsxReadContext = new DefaultXlsxReadContext(readWorkbook, ExcelTypeEnum.XLSX);
                analysisContext = xlsxReadContext;
                excelReadExecutor = new XlsxSaxAnalyser2(xlsxReadContext, null);
                break;
            case CSV:
